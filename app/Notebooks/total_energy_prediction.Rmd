...
electricity_net_generation_pivot_df <-  sparklyr::sdf_persist(electricity_net_generation_pivot_df)
```
...
electricity_net_generation_pivot_reduced_df <-  sparklyr::sdf_persist(electricity_net_generation_pivot_reduced_df)
